...
from apps.pdf_diff_system_withannotation.app.modules.diff_detection.phrase_based_diff_detector import (
    PhraseBasedDiffDetector
)
from apps.pdf_diff_system_withannotation.app.application.services.ab_test_service import ABTestService
...
def main():
    ...
    try:
        ...
        from apps.pdf_diff_system_withannotation.app.infrastructure.evaluation.segmentation_comparison_generator import SegmentationComparisonGenerator
