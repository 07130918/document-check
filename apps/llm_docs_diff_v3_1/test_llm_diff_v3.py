...
# v3-1のモジュールをインポート
import apps.llm_docs_diff_v3_1 as v3_1
from apps.llm_docs_diff_v3_1.services.azure_service_enhanced import AzureDocumentServiceEnhanced
from apps.llm_docs_diff_v3_1.services.llm_service import LLMService
from apps.llm_docs_diff_v3_1.core.text_preprocessing import TextPreprocessor
from apps.llm_docs_diff_v3_1.core.diff_detector_v3 import ContentBasedDiffDetector
from apps.llm_docs_diff_v3_1.handlers.output_handler import OutputHandler
from apps.llm_docs_diff_v3_1.models.bbox_models import ComparisonResult, DiffResult, ChangeType
from apps.llm_docs_diff_v3_1.core.reading_order_v2 import ReadingOrderEstimatorV2
from apps.llm_docs_diff_v3_1.config.settings import settings
import time
import logging
...
def main():
    ...
    if settings.USE_HIGH_RESOLUTION_OCR:
        output_base_dir = settings.OUTPUT_DIR.parent / "llm_diff_test_v3-1_high_resolution"
    else:
        output_base_dir = settings.OUTPUT_DIR.parent / "llm_diff_test_v3-1_standard"
    ...
    print(f"結果は {relative_output} に保存されました ({resolution_type})")
